...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                new JoystickButton(m_driverController, Button.kBumperRight.value)
                                ...
                                .whenReleased(() -> m_intake.disableIntake());
                // right trigger --- shoot all balls
                new Trigger(() -> m_driverController
                                .getTriggerAxis(Hand.kLeft) > Constants.OIconstants.kLeftTriggerThreshold
                                || m_driverController.getTriggerAxis(
                                                Hand.kRight) > Constants.OIconstants.kRightTriggerThreshold)
                                                                .whileActiveOnce(new VisionShoot(m_intake, m_indexer,
                                                                                m_loaderPID, m_leftShooterPID,
                                                                                m_rightShooterPID, m_hood, m_limelight,
                                                                                m_drive,
                                                                                () -> m_driverController.getTriggerAxis(
                                                                                                Hand.kLeft) > Constants.OIconstants.kLeftTriggerThreshold,
                                                                                () -> m_driverController.getTriggerAxis(
                                                                                                Hand.kRight) > Constants.OIconstants.kRightTriggerThreshold,
                                                                                () -> m_driverController
                                                                                                .getY(Hand.kLeft),
